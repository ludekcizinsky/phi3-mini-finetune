...
class OpenBookQAName(Enum):
    Main = "main"
    Additional = "additional"


class OpenBookQABaseData(BaseDataset, ABC):
    """The OpenBookQABaseDataset Dataset. (NB: Base class only, should not be instantiated itself.)
    ...
    Contains:
    - OpenBookQAMainData: The main dataset.
    - OpenBookQAAdditionalData: The additional dataset.

    HF - https://huggingface.co/datasets/allenai/openbookqa
    """

    ID = "openbookqa"
    PATH = "allenai/openbookqa"
    NAME: OpenBookQAName = None
